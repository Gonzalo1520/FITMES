...
en su vida, es por ello que Fitmes desea identificar cuales son los usuarios que miden de 1.80 m a más, obteniendo solo 
...
los nombres de los nutricionistas cuya experiencia sea mayor a 3 años, para que así estos puedan recibir una bonificación a futuro.*/

db.Nutricionista.find({Experiencia:{$gt:3}}, {Nombres:1,Experiencia:1,_id:0});

/*3.	Ya han pasado mas de 1 año y medio del lanzamiento de Fitmes por ende, la empresa requiere hacer una evaluación de los 
platillos saludables que se encuentran disponibles acorde a la cantidad de calorías, bajo la siguiente condición, si el platillo 
posee más de 610 calorías deberá de ser eliminado, para ello solo se necesita obtener el nombre del platillo y la cantidad de calorías.*/
